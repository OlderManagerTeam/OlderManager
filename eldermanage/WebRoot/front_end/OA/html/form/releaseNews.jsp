...
<link rel="stylesheet" type="text/css"
	href="../../lib/css/checkbox3.min.css">
<link rel="stylesheet" type="text/css"
				...
				<div id="dropdown-form" class="panel-collapse collapse">
					<div class="panel-body">
						<ul class="nav navbar-nav">
							...
							<li><a href="../form/releaseNews.html">发布新闻</a></li>
						</ul>
					</div>
				</div></li>
			<!-- Dropdown-->
				...
				<div class="col-xs-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<div class="sub-title">编辑新闻标题</div>
							<div>
								<input type="text" class="form-control" placeholder="Text input">
							</div>
							<div class="sub-title">编辑新闻内容</div>
					...
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button type="button" id="newssubmit">立即提交</button>
	...
	<div>
		...
		<script type="text/javascript">
			...
			$("#reset").click(function() {
				newscontent.txt.html("");
			});
		
		/* 	$("#newssubmit").click(function() {
				alert(newscontent.txt.html());
				var content = newscontent.txt.html();
		
				//$("#con").val(data);
				$.ajax({
					type : 'GET',
					url : "http://localhost:8080/eldermanage/v1/news/publish?content=" + content,
					data : null,
					success : function(result) {
						if (result.success) {
							alert(result.success)
						//window.location.href = "http://localhost:8080/eldermanage/front_end/OA/html/olderEducation/videoView.html";
						}
					//alert(result.success)
					},
					error : function() {
		...
		<script type="text/javascript">
			$("#newssubmit").click(function() {
				...
				form.append("content",newscontent.txt.html());
				alert(newscontent.txt.html());
				$.ajax({
					type : 'post',
					url : "http://localhost:8080/eldermanage/v1/news/publish.action",
					data : form,
					processData : false,
					contentType : false,
					success : function(result) {
						//var resultdata = JSON.parse(result);
						 if (result.success) {
							window.location.href = "http://localhost:8080/eldermanage/front_end/OA/html/olderInfoManager/olderView.html";
						} 
						//alert(result.success)
					},
					error : function() {
